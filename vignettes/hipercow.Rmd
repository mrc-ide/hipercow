...
This prints out information about the task; it's identifer (`329aacd2b13da41e768ac15c3764bf6a`) and status (`success`), along with the time that key events happened for the task (when it was created, started and finished). 
