...
#> 
#> ── hipercow root at /home/rfitzjoh/net/home/cluster/hipercow-vignette/hv-20240110-50ab6375fe865 ───
...
#> ✔ Submitted task '40d27cb021457a157b55c392c28e523a' using 'windows'
```
...
#> ✔ Submitted task '846ea49229ef98e8af262a3239257010' using 'windows'
task_wait(id)
#> [1] FALSE
task_result(id)
...
```r
id <- task_create_expr(random_walk(0, 10))
#> ✔ Submitted task '92e3706bda0081a55dceb263792db3fe' using 'windows'
task_wait(id)
#> [1] TRUE
task_result(id)
...
task_info(id)
#> 
#> ── task 92e3706bda0081a55dceb263792db3fe (success) ────────────────────────────────────────────────
#> ℹ Submitted with 'windows'
#> ℹ Created at 2024-01-10 10:33:13.059888 (moments ago)
#> ℹ Started at 2024-01-10 10:33:13.789803 (moments ago; waited 730ms)
#> ℹ Finished at 2024-01-10 10:33:14.213412 (moments ago; ran for 424ms)
```
...
task_log_show(id)
#> 
#> ── hipercow 0.2.9 running at 'V:/cluster/hipercow-vignette/hv-20240110-50ab6375f
#> ℹ library paths:
#> •
...
#> ℹ id: 92e3706bda0081a55dceb263792db3fe
#> ℹ starting at: 2024-01-10 10:33:13.789803
...
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2024-01-10 10:33:13.789803 (elapsed: 0.4392 secs)
```
...
#> ✔ Submitted task '1f62af10a9a59fb4bb3a1578a6055ef2' using 'windows'
```
...
#> ✔ Submitted task '66b355a95e9ac588030784270ce6b410' using 'windows'
```
...
task_info(id)
#> 
#> ── task 66b355a95e9ac588030784270ce6b410 (running) ────────────────────────────────────────────────
#> ℹ Submitted with 'windows'
#> ℹ Created at 2024-01-10 10:33:16.298285 (moments ago)
#> ℹ Started at 2024-01-10 10:33:17.263568 (moments ago; waited 966ms)
...
```r
task_cancel(id)
#> ✔ Successfully cancelled '66b355a95e9ac588030784270ce6b410'
#> [1] TRUE
task_status(id)
#> [1] "cancelled"
task_info(id)
#> 
#> ── task 66b355a95e9ac588030784270ce6b410 (cancelled) ──────────────────────────────────────────────
#> ℹ Submitted with 'windows'
#> ℹ Created at 2024-01-10 10:33:16.298285 (moments ago)
#> ℹ Started at 2024-01-10 10:33:17.263568 (moments ago; waited 966ms)
#> ℹ Finished at 2024-01-10 10:33:19.762556 (moments ago; ran for 2.5s)
```
...
#> ✔ Submitted task '758168a1a3eb6045e87553000f4a6266' using 'windows'
task_wait(id1)
#> [1] TRUE
task_result(id1)
...
```r
id2 <- task_retry(id1)
#> ✔ Submitted task '3f8383545017aca47f11fe937d2b44cb' using 'windows'
```
...
task_info(id2)
#> 
#> ── task 3f8383545017aca47f11fe937d2b44cb (success) ────────────────────────────────────────────────
#> ℹ Submitted with 'windows'
#> ℹ Created at 2024-01-10 10:33:19.810693 (moments ago)
#> ℹ Started at 2024-01-10 10:33:22.004266 (moments ago; waited 2.2s)
#> ℹ Finished at 2024-01-10 10:33:22.439971 (moments ago; ran for 436ms)
