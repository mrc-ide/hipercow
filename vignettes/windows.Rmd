...
#> ✔ Path looks like it is on a network share
#> ℹ Using 'Q:/testcow/hv-20240205-30a848af5801'
#> ✔ Submitted task '6314ab028d3f50bcd3c31811dbe5f773' using 'windows'
#> 
#> ── hipercow 0.2.37 running at 'Q:/testcow/hv-20240205-30a848af5801' ────────────
#> ℹ library paths:
#> • Q:/testcow/hv-20240205-30a848af5801/hipercow/lib/windows/4.3.2
#> • I:/bootstrap/4.3.2
#> • C:/Program Files/R/R-4.3.2/library
#> ℹ id: 6314ab028d3f50bcd3c31811dbe5f773
#> ℹ starting at: 2024-02-05 09:51:09.810232
...
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2024-02-05 09:51:09.810232 (elapsed: 1.012 secs)
#> ✔ Successfully ran test task '6314ab028d3f50bcd3c31811dbe5f773'
```
...
#> 
#> ── hipercow root at Q:/testcow/hv-20240205-30a848af5801 ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ✔ Working directory '.' within root
#> ℹ R version 4.3.2 on Windows (wrh1@WPIA-DIDE065)
#> 
#> ── Packages ──
#> 
#> ℹ This is hipercow 0.2.42
#> ℹ Installed: hipercow.windows (0.2.42), conan2 (1.9.99), logwatch (0.1.0)
#> 
#> ── Environments ──
#> 
#> ── default
...
#> • cluster: wpia-hn
#> • shares: 1 configured:
#> → (local) Q:/ => \\fi--san03.dide.ic.ac.uk\homes\wrh1 => q: (remote)
#> • r_version: 4.3.2
...
#> 
#> $r_versions
#> [1] '4.0.5' '4.1.3' '4.2.3' '4.3.0' '4.3.2'
#> 
#> $redis_url
