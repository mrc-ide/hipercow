...
```r
hipercow_provision()
#> Bootstrapping from: I:/bootstrap-dev/4.3.0
#> Installing into library: hipercow/lib/windows/4.3.0
#> Running in path: V:/cluster/hipercow-vignette/hv-20231222-1247ca775a2f
#> Loading required namespace: ps
#> Loading required namespace: cli
#> Loading required namespace: curl
#> Loading required namespace: filelock
#> Loading required namespace: pkgdepends
#> Loading required namespace: pkgcache
#> Loading required namespace: processx
#> Loading required namespace: lpSolve
#> Loading required namespace: jsonlite
#> Loading required namespace: withr
#> Loading required namespace: desc
#> Loading required namespace: zip
#> Loading required namespace: pkgbuild
#> Loading required namespace: callr
#> Library paths:
#>   - V:/cluster/hipercow-vignette/hv-20231222-1247ca775a2f/hipercow/lib/windows/4.3.0
...
#> ✔ Got crayon 1.5.2 (i386+x86_64-w64-mingw32) (162.48 kB)
...
#> ✔ Installed cowsay 0.9.0  (649ms)
#> ✔ Installed crayon 1.5.2  (513ms)
#> ✔ Installed rmsfact 0.0.3  (615ms)
#> ✔ Installed fortunes 1.5-4  (837ms)
#> ✔ Summary:   4 new  in 2.6s
#>
#> -------------------------------------------------------------------------------
#> ✔ Installation script finished successfully in 6.523 secs
```
...
#> ✔ Submitted task '5af5d7d29d567f18e515e7fc107f6b7c' using 'windows'
task_wait(id)
#> [1] TRUE
task_log_show(id)
#>
#> ── hipercow running at 'V:/cluster/hipercow-vignette/hv-20231222-1247ca775a2f' ─
#> ℹ id: 5af5d7d29d567f18e515e7fc107f6b7c
#> ℹ starting at: 2023-12-22 16:10:00.220797
...
#>              ||      ||───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2023-12-22 16:10:00.220797 (elapsed: 0.6508 secs)
```
...
#> ✔ Got coda 0.19-4 (i386+x86_64-w64-mingw32) (322.24 kB)
#> ✔ Installed coda 0.19-4  (557ms)
#> ✔ Summary:   1 new   1 kept  in 557ms
#>
#> -------------------------------------------------------------------------------
#> ✔ Installation script finished successfully in 5.385 secs
```
...
#> Bootstrapping from: I:/bootstrap-dev/4.3.0
#> Installing into library: hipercow/lib/windows/4.3.0
#> Running in path: V:/cluster/hipercow-vignette/hv-20231222-1247c28601536
#> Loading required namespace: ps
#> Loading required namespace: cli
#> Loading required namespace: curl
#> Loading required namespace: filelock
...
#> Loading required namespace: callr
#> Library paths:
#>   - V:/cluster/hipercow-vignette/hv-20231222-1247c28601536/hipercow/lib/windows/4.3.0
#>   - C:/Program Files/R/R-4.3.0/library
#> Logs from pkgdepends follow:
#>
#> -------------------------------------------------------------------------------
...
#> ✔ Got cowsay 0.9.0 (i386+x86_64-w64-mingw32) (402.57 kB)
#> ✔ Cached copy of rmsfact 0.0.3 (i386+x86_64-w64-mingw32) is the latest build
#> ✔ Installed crayon 1.5.2  (700ms)
#> ✔ Installed cowsay 0.9.0  (1000ms)
#> ✔ Installed rmsfact 0.0.3  (981ms)
#> ✔ Installed fortunes 1.5-4  (1.2s)
#> ✔ Summary:   4 new  in 3.9s
#>
#> -------------------------------------------------------------------------------
#> ✔ Installation script finished successfully in 6.444 secs
```
...
#> ✔ Submitted task '4bbc3bdade0bac15ed128a4486227ff6' using 'windows'
task_wait(id)
#> [1] TRUE
task_log_show(id)
#>
#> ── hipercow running at 'V:/cluster/hipercow-vignette/hv-20231222-1247c28601536'
#> ℹ id: 4bbc3bdade0bac15ed128a4486227ff6
#> ℹ starting at: 2023-12-22 16:10:20.307722
#> ℹ task type: expression
...
#>   ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2023-12-22 16:10:20.307722 (elapsed: 2.115 secs)
```
...
#> ✔ Installed rfiglet 0.2.0 (github::richfitz/rfiglet@d713c1b) (710ms)
#> ✔ Summary:   1 new   4 kept  in 710ms
#>
#> -------------------------------------------------------------------------------
#> ✔ Installation script finished successfully in 6.496 secs
```


```r
id <- task_create_expr(figlet_date())
#> ✔ Submitted task 'dd6b8feb34682b3cae012a6a92ec4386' using 'windows'
task_wait(id)
#> [1] TRUE
task_log_show(id)
#>
#> ── hipercow running at 'V:/cluster/hipercow-vignette/hv-20231222-1247c28601536'
#> ℹ id: dd6b8feb34682b3cae012a6a92ec4386
#> ℹ starting at: 2023-12-22 16:10:33.753485
#> ℹ task type: expression
#> ℹ expression: figlet_date()
#> ℹ no local variables
#> ───────────────────────────────────────────────────────────────── task logs ↓ ──
#>  ____   ___ ____  _____       _ ____      ____  ____
#> |___ \ / _ \___ \|___ /      / |___ \    |___ \|___ \
#>   __) | | | |__) | |_ \ _____| | __) |____ __) | __) |
#>  / __/| |_| / __/ ___) |_____| |/ __/_____/ __/ / __/
#> |_____|\___/_____|____/      |_|_____|   |_____|_____|
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2023-12-22 16:10:33.753485 (elapsed: 0.5401 secs)
```
...
#> Bootstrapping from: I:/bootstrap-dev/4.3.0
#> Installing into library: hipercow/lib/windows/4.3.0
#> Running in path: V:/cluster/hipercow-vignette/hv-20231222-1247c2213af9f
#> Loading required namespace: remotes
#> Library paths:
#>   - V:/cluster/hipercow-vignette/hv-20231222-1247c2213af9f/hipercow/lib/windows/4.3.0
#>   - C:/Program Files/R/R-4.3.0/library
...
#>
#> > install.packages("cowsay")
#> Installing package into 'V:/cluster/hipercow-vignette/hv-20231222-1247c2213af9f/hipercow/lib/windows/4.3.0'
...
#> Content type 'application/zip' length 162482 bytes (158 KB)
#> ==================================================
#> downloaded 158 KB
#>
...
#> Content type 'application/zip' length 402567 bytes (393 KB)
#> ==================================================
#> downloaded 393 KB
...
#> 	C:\Users\rfitzjoh\AppData\Local\Temp\Rtmp0mAJ3t\downloaded_packages
#>
#> > cowsay::say("Moo", "cow")
#>
#>  -----
...
#>              ||      ||
#> -------------------------------------------------------------------------------
#> ✔ Installation script finished successfully in 7.873 secs
```
