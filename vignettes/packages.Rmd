...
#> Running in path: V:/cluster/hipercow-vignette/hv-20240111-7947a3be4df00
#> Library paths:
#>   - V:/cluster/hipercow-vignette/hv-20240111-7947a3be4df00/hipercow/lib/windows/4.3.0
...
#> ✔ Installed cowsay 0.9.0  (628ms)
#> ✔ Installed crayon 1.5.2  (494ms)
#> ✔ Installed rmsfact 0.0.3  (580ms)
#> ✔ Installed fortunes 1.5-4  (785ms)
#> ✔ Summary:   4 new  in 2.5s
#> 
#> -------------------------------------------------------------------------------
#> Writing library description to 'hipercow/lib/windows/4.3.0/.conan/20240111102334'
#> Done!
#> ✔ Installation script finished successfully in 7.337 secs
```
...
#> ✔ Submitted task '36922630ef149b2b60e6fc20039a1d26' using 'windows'
task_wait(id)
#> [1] TRUE
task_log_show(id)
#> 
#> ── hipercow 0.2.9 running at 'V:/cluster/hipercow-vignette/hv-20240111-7947a3be4
#> ℹ library paths:
#> •
#> V:/cluster/hipercow-vignette/hv-20240111-7947a3be4df00/hipercow/lib/windows/4.3.0
#> • I:/bootstrap/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: 36922630ef149b2b60e6fc20039a1d26
#> ℹ starting at: 2024-01-11 10:23:41.63217
...
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2024-01-11 10:23:41.63217 (elapsed: 0.6593 secs)
```
...
#> • 1: 20240111102334 (moments ago) [0]
```

The `hipercow_provision_check()` function also compares prevously performed installations with the what `hipercow_provision()` would do with the same arguments:
...
#> • (empty installation)
#> • 20240111102334 1st; current installation (moments ago)
#> 
#> ── 4 added packages ──
#> 
#> • cowsay (0.9.0) CRAN
...
#> ✔ Installed coda 0.19-4  (446ms)
#> ✔ Summary:   1 new   1 kept  in 446ms
#> 
#> -------------------------------------------------------------------------------
#> Writing library description to 'hipercow/lib/windows/4.3.0/.conan/20240111102345'
#> Done!
#> ✔ Installation script finished successfully in 6.35 secs
```
...
#> Installing into library: hipercow/lib/windows/4.3.0
#> Using method auto
#> Running in path: V:/cluster/hipercow-vignette/hv-20240111-7947a2bb2d825
#> Library paths:
#>   - V:/cluster/hipercow-vignette/hv-20240111-7947a2bb2d825/hipercow/lib/windows/4.3.0
#>   - C:/Program Files/R/R-4.3.0/library
#> id: 20240111102352
#> Logs from pkgdepends follow:
#> 
...
#> ✔ Cached copy of rmsfact 0.0.3 (i386+x86_64-w64-mingw32) is the latest build
#> ✔ Got cowsay 0.9.0 (i386+x86_64-w64-mingw32) (402.57 kB)
#> ✔ Installed cowsay 0.9.0  (748ms)
#> ✔ Installed crayon 1.5.2  (783ms)
#> ✔ Installed rmsfact 0.0.3  (871ms)
#> ✔ Installed fortunes 1.5-4  (1.1s)
#> ✔ Summary:   4 new  in 3.5s
#> 
#> -------------------------------------------------------------------------------
#> Writing library description to 'hipercow/lib/windows/4.3.0/.conan/20240111102352'
#> Done!
#> ✔ Installation script finished successfully in 6.276 secs
```
...
#> ✔ Submitted task '907a60248899c0c9688da5f9757ab597' using 'windows'
task_wait(id)
#> [1] TRUE
task_log_show(id)
#> 
#> ── hipercow 0.2.9 running at 'V:/cluster/hipercow-vignette/hv-20240111-7947a2bb2
#> ℹ library paths:
#> •
#> V:/cluster/hipercow-vignette/hv-20240111-7947a2bb2d825/hipercow/lib/windows/4.3.0
#> • I:/bootstrap/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: 907a60248899c0c9688da5f9757ab597
#> ℹ starting at: 2024-01-11 10:23:58.660499
#> ℹ task type: expression
...
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2024-01-11 10:23:58.660499 (elapsed: 1.869 secs)
```
...
#> ✔ Installed rfiglet 0.2.0 (github::richfitz/rfiglet@d713c1b) (636ms)
#> ✔ Summary:   1 new   4 kept  in 636ms
#> 
#> -------------------------------------------------------------------------------
#> Writing library description to 'hipercow/lib/windows/4.3.0/.conan/20240111102402'
#> Done!
#> ✔ Installation script finished successfully in 6.31 secs
```


```r
id <- task_create_expr(figlet_date())
#> ✔ Submitted task 'f6159688efb0076acec33785ed8cb387' using 'windows'
task_wait(id)
#> [1] TRUE
task_log_show(id)
#> 
...
#> • I:/bootstrap/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: f6159688efb0076acec33785ed8cb387
#> ℹ starting at: 2024-01-11 10:24:08.79
#> ℹ task type: expression
...
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✔ status: success
#> ℹ finishing at: 2024-01-11 10:24:08.79 (elapsed: 0.5787 secs)
```
...
#> Installing into library: hipercow/lib/windows/4.3.0
#> Using method script
#> Running in path: V:/cluster/hipercow-vignette/hv-20240111-7947a6af45185
#> Library paths:
#>   - V:/cluster/hipercow-vignette/hv-20240111-7947a6af45185/hipercow/lib/windows/4.3.0
#>   - C:/Program Files/R/R-4.3.0/library
#> id: 20240111102412
...
#> 
#> > install.packages("cowsay")
#> Installing package into 'V:/cluster/hipercow-vignette/hv-20240111-7947a6af45185/hipercow/lib/windows/4.3.0'
...
#> 	C:\Users\rfitzjoh\AppData\Local\Temp\RtmpaGA38F\downloaded_packages
#> 
#> > cowsay::say("Moo", "cow")
#> 
#>  ----- 
...
#>              ||      ||
#> -------------------------------------------------------------------------------
#> Writing library description to 'hipercow/lib/windows/4.3.0/.conan/20240111102412'
#> Done!
#> ✔ Installation script finished successfully in 4.285 secs
```
