...
#> ✔ Submitted task '4ff501cbbb6272b29950099ac367a892' using 'windows'
```
...
task_log_show(id)
#>
#> ── hipercow running at 'V:/cluster/hipercow-vignette/hv-20231222-12688676de8fa'
#> ℹ id: 4ff501cbbb6272b29950099ac367a892
#> ℹ starting at: 2023-12-22 16:12:17.442455
...
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✖ status: failure
#> ℹ finishing at: 2023-12-22 16:12:17.442455 (elapsed: 0.3867 secs)
```
...
#> ✔ Submitted task '5757c61d3f6e9085e7ebcbb82ff63965' using 'windows'
```
...
#>
#> ── hipercow running at 'V:/cluster/hipercow-vignette/hv-20231222-12688676de8fa'
#> ℹ id: 5757c61d3f6e9085e7ebcbb82ff63965
#> ℹ starting at: 2023-12-22 16:12:20.973018
#> ℹ task type: expression
...
#> ───────────────────────────────────────────────────────────────── task logs ↑ ──
#> ✖ status: failure
#> ℹ finishing at: 2023-12-22 16:12:20.973018 (elapsed: 0.3664 secs)
#> Warning message:
#> In file(file, "rt") :
...
#>   7. ├─hipercow:::task_eval_expression(data, envir, verbose, root)
...
We can create an environmnent with this code and use it just fine:
...
#> ✔ Submitted task '74ebdcae2a90ef1cbd203edb7d389b18' using 'windows'
task_wait(id)
#> [1] TRUE
task_result(id)
#> [1] 20
...
id <- task_create_expr(times2(10))
#> ✔ Submitted task 'e393bfad03a498f62d5eabf2a5efed5c' using 'windows'
task_wait(id)
#> [1] FALSE
task_status(id)
#> [1] "failure"
...
#>
#> ── hipercow running at 'V:/cluster/hipercow-vignette/hv-20231222-12688676de8fa'
#> ℹ id: e393bfad03a498f62d5eabf2a5efed5c
#> ℹ starting at: 2023-12-22 16:12:28.268606
#> ℹ task type: expression
#> ✖ status: failure
#> ℹ finishing at: 2023-12-22 16:12:28.268606 (elapsed: 0.3305 secs)
```
...
#> ✔ Submitted task 'ec21ab0b90103c203a4572df5ff64dea' using 'windows'
```
...
#> Error in `task_wait()`:
#> ! Task 'ec21ab0b90103c203a4572df5ff64dea' did not complete in time
#>   (status: timeout)
```
...
* Your DIDE username (as this makes seeing task statuses much easier)
