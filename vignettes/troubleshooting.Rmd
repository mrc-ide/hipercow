...
#> ✔ Submitted task 'c46b56bb650ddd7862c9a8e0fc98338f' using 'windows'
```
...
task_log_show(id)
#> 
#> ── hipercow 0.2.9 running at 'V:/cluster/hipercow-vignette/hv-20240110-50ab62697
#> ℹ library paths:
#> •
#> V:/cluster/hipercow-vignette/hv-20240110-50ab626972bc8/hipercow/lib/windows/4.3.0
#> • I:/bootstrap-dev/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: c46b56bb650ddd7862c9a8e0fc98338f
#> ℹ starting at: 2024-01-10 10:33:39.459115
...
#> ℹ finishing at: 2024-01-10 10:33:39.459115 (elapsed: 0.4461 secs)
```
...
#> ✔ Submitted task 'e82c3d9cafef9ba59c863cbecf5b284e' using 'windows'
```
...
#> • I:/bootstrap-dev/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: e82c3d9cafef9ba59c863cbecf5b284e
#> ℹ starting at: 2024-01-10 10:33:40.879754
#> ℹ task type: expression
...
#> ℹ finishing at: 2024-01-10 10:33:40.879754 (elapsed: 0.4491 secs)
```
...
#> ✔ Submitted task '2e1b287b43f7c8808c59861b44d37836' using 'windows'
task_wait(id)
#> [1] TRUE
task_result(id)
#> [1] 20
...
id <- task_create_expr(times2(10))
#> ✔ Submitted task 'fb791c877291c1e385ac2b0786a6e2eb' using 'windows'
task_wait(id)
#> [1] FALSE
task_status(id)
#> [1] "failure"
...
#> • I:/bootstrap-dev/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: fb791c877291c1e385ac2b0786a6e2eb
#> ℹ starting at: 2024-01-10 10:33:43.797295
#> ℹ task type: expression
#> ✖ status: failure
#> ✖ Error: 5:0: unexpected end of input 3: } 4: newfun <- function(x)   ^
#> ℹ finishing at: 2024-01-10 10:33:43.797295 (elapsed: 0.3713 secs)
```
...
#> ✔ Submitted task 'ded767f7608e1dea6d8c7e66541fedd8' using 'windows'
```
...
#> Error in `task_wait()`:
#> ! Task 'ded767f7608e1dea6d8c7e66541fedd8' did not complete in time (status: timeout)
```
...
```r
task_info(id)
#> ! Fixing status of 'ded767f7608e1dea6d8c7e66541fedd8' from 'submitted' to 'failure'
#> ℹ If this is unexpected, consider checking the logs for more information:
#> • task_logs("ded767f7608e1dea6d8c7e66541fedd8")
#> • task_logs("ded767f7608e1dea6d8c7e66541fedd8", outer = TRUE)
#> 
#> ── task ded767f7608e1dea6d8c7e66541fedd8 (failure) ────────────────────────────────────────────────
#> ℹ Submitted with 'windows'
#> ℹ Created at 2024-01-10 10:33:44.547261 (less than a minute ago)
#> ✖ Start time unknown!
#> ℹ Finished at 2024-01-10 10:33:55.348049 (moments ago; ran for ???)
```
...
```r
task_log_show(id)
#> ✖ No logs for task 'ded767f7608e1dea6d8c7e66541fedd8' (yet?)
```
