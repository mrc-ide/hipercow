...
#> ✔ Submitted task 'cdffb69bf7da8223b07a5923732e55f4' using 'windows'
```
...
task_log_show(id)
#> 
#> ── hipercow 0.2.9 running at 'V:/cluster/hipercow-vignette/hv-20240111-796487132
#> ℹ library paths:
#> •
#> V:/cluster/hipercow-vignette/hv-20240111-796487132a9d0/hipercow/lib/windows/4.3.0
#> • I:/bootstrap/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: cdffb69bf7da8223b07a5923732e55f4
#> ℹ starting at: 2024-01-11 10:24:24.248448
...
#> ℹ finishing at: 2024-01-11 10:24:24.248448 (elapsed: 0.4148 secs)
```
...
#> ✔ Submitted task 'eac7d82e7501f674eb5cdee1fc4795d9' using 'windows'
```
...
#> • I:/bootstrap/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: eac7d82e7501f674eb5cdee1fc4795d9
#> ℹ starting at: 2024-01-11 10:24:25.683946
#> ℹ task type: expression
...
#> ℹ finishing at: 2024-01-11 10:24:25.683946 (elapsed: 0.4392 secs)
```
...
#> ✔ Submitted task '41a5713901791877dfdb9dc7ca52955e' using 'windows'
task_wait(id)
#> [1] TRUE
task_result(id)
#> [1] 20
...
id <- task_create_expr(times2(10))
#> ✔ Submitted task '59e80385352f14ba2d6ee3853811a507' using 'windows'
task_wait(id)
#> [1] FALSE
task_status(id)
#> [1] "failure"
...
#> • I:/bootstrap/4.3.0
#> • C:/Program Files/R/R-4.3.0/library
#> ℹ id: 59e80385352f14ba2d6ee3853811a507
#> ℹ starting at: 2024-01-11 10:24:28.729642
#> ℹ task type: expression
#> ✖ status: failure
#> ✖ Error: 5:0: unexpected end of input 3: } 4: newfun <- function(x)   ^
#> ℹ finishing at: 2024-01-11 10:24:28.729642 (elapsed: 0.3661 secs)
```
...
#> ✔ Submitted task 'cb0e91162e5e4aae38177c1fa5fb6d51' using 'windows'
```
...
#> Error in `task_wait()`:
#> ! Task 'cb0e91162e5e4aae38177c1fa5fb6d51' did not complete in time (status: timeout)
```
...
```r
task_info(id)
#> ! Fixing status of 'cb0e91162e5e4aae38177c1fa5fb6d51' from 'submitted' to 'failure'
#> ℹ If this is unexpected, consider checking the logs for more information:
#> • task_logs("cb0e91162e5e4aae38177c1fa5fb6d51")
#> • task_logs("cb0e91162e5e4aae38177c1fa5fb6d51", outer = TRUE)
#> 
#> ── task cb0e91162e5e4aae38177c1fa5fb6d51 (failure) ────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> ℹ Submitted with 'windows'
#> ℹ Created at 2024-01-11 10:24:29.361449 (less than a minute ago)
#> ✖ Start time unknown!
#> ℹ Finished at 2024-01-11 10:24:40.136737 (moments ago; ran for ???)
```
...
```r
task_log_show(id)
#> ✖ No logs for task 'cb0e91162e5e4aae38177c1fa5fb6d51' (yet?)
```
