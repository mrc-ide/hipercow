test_that("can create a script-based task", {
  ...
  d <- readRDS(path_to_task_file(path, id, "data"))
...
test_that("can change directory in script", {
  ...
  d1 <- readRDS(path_to_task_file(path, id1, "data"))
  d2 <- readRDS(path_to_task_file(path, id2, "data"))
  d3 <- readRDS(path_to_task_file(path, id3, "data"))
  d4 <- readRDS(path_to_task_file(path, id4, "data"))
