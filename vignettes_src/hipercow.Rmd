...
This prints out information about the task; it's identifier (`r inline(id)`) and status (`success`), along with the time that key events happened for the task (when it was created, started and finished).
